...
export class Bone {
  ...
  public position: Vec3; // current position of the bone's joint *in world coordinates*. Used by the provided skeleton shader, so you need to keep this up to date. //this updated by animation
  public endpoint: Vec3; // current position of the bone's second (non-joint) endpoint, in world coordinates //this updated by animation
  public rotation: Quat; // current orientation of the joint *with respect to world coordinates* //this updated by animation
  
  public initialPosition: Vec3; // position of the bone's joint *in world coordinates*  //starting (rest) initial coordinates
